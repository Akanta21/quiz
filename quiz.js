...
var question1 = new Question(generateQn(), [generateRandom(), generateRandom(), generateRandom(), randomTotal], 2)
var question2 = new Question(generateQn(), [generateRandom(), generateRandom(), generateRandom(), randomTotal], 2)
var question3 = new Question(generateQn(), [generateRandom(), generateRandom(), generateRandom(), randomTotal], 2)
var question4 = new Question(generateQn(), [generateRandom(), generateRandom(), generateRandom(), randomTotal], 2)
var question5 = new Question(generateQn(), [generateRandom(), generateRandom(), generateRandom(), randomTotal], 2)
var question6 = new Question(generateQn(), [generateRandom(), generateRandom(), generateRandom(), randomTotal], 2)
